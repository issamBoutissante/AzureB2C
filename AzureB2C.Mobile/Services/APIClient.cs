...
namespace AzureB2C.Mobile.Services
{
    ...
    public static class APIClient
    {
        ...
        {
            HttpClient = new();
            //HttpClient.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", "65924785fba14e789c297801248a0036");
            HttpClient.Timeout = TimeSpan.FromSeconds(60);
            HttpClient.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", accessToken);
            Client = new(@"https://e4fc-105-71-16-111.ngrok-free.app", HttpClient);
        }
    }
    ...
    public partial class Client
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<User> UsersPOSTAsync(User body)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<User> UsersPOSTAsync(User body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Users");
